...
public class Shaders {
    private static final String vertexShaderSource = FileUtil.readFile("src/main/java/Shaders/vertex-shader.glsl");

    private static final String fragmentShaderSource = FileUtil.readFile("src/main/java/Shaders/fragment-shader.glsl");
